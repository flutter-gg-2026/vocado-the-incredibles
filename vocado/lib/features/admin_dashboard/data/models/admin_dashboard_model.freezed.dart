...
mixin _$AdminDashboardModel {
 ...
 String get id; String get task;@JsonKey(name: 'name') String? get assignee; String get assigneeId; DateTime get dueDate; DateTime get createdAt; bool get completed;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,task,assignee,assigneeId,dueDate,createdAt,completed);

@override
String toString() {
  return 'AdminDashboardModel(id: $id, task: $task, assignee: $assignee, assigneeId: $assigneeId, dueDate: $dueDate, createdAt: $createdAt, completed: $completed)';
}
...
@useResult
$Res call({
 String id, String task,@JsonKey(name: 'name') String? assignee, String assigneeId, DateTime dueDate, DateTime createdAt, bool completed
});
...
/// Create a copy of AdminDashboardModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? task = null,Object? assignee = freezed,Object? assigneeId = null,Object? dueDate = null,Object? createdAt = null,Object? completed = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String task, @JsonKey(name: 'name')  String? assignee,  String assigneeId,  DateTime dueDate,  DateTime createdAt,  bool completed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminDashboardModel() when $default != null:
return $default(_that.id,_that.task,_that.assignee,_that.assigneeId,_that.dueDate,_that.createdAt,_that.completed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String task, @JsonKey(name: 'name')  String? assignee,  String assigneeId,  DateTime dueDate,  DateTime createdAt,  bool completed)  $default,) {final _that = this;
switch (_that) {
case _AdminDashboardModel():
return $default(_that.id,_that.task,_that.assignee,_that.assigneeId,_that.dueDate,_that.createdAt,_that.completed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String task, @JsonKey(name: 'name')  String? assignee,  String assigneeId,  DateTime dueDate,  DateTime createdAt,  bool completed)?  $default,) {final _that = this;
switch (_that) {
case _AdminDashboardModel() when $default != null:
return $default(_that.id,_that.task,_that.assignee,_that.assigneeId,_that.dueDate,_that.createdAt,_that.completed);case _:
  return null;
...
class _AdminDashboardModel implements AdminDashboardModel {
  const _AdminDashboardModel({required this.id, required this.task, @JsonKey(name: 'name') this.assignee, required this.assigneeId, required this.dueDate, required this.createdAt, required this.completed});
...
@override@JsonKey(name: 'name') final  String? assignee;
...
/// Create a copy of AdminDashboardModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? task = null,Object? assignee = freezed,Object? assigneeId = null,Object? dueDate = null,Object? createdAt = null,Object? completed = null,}) {
